# 九州アプリチャレンジ・キャラバン2017参加同意書など

このドキュメントは九州アプリチャレンジキャラバン2017の開催にあたり、イベントでの知的財産権等の取り扱いについて参加者の同意を必要とする事項をまとめたものであり、次節に示す「[ハッカソン／メイカソン参加同意書と終了後の確認書およびFAQ](https://github.com/IAMAS/makeathon_agreement)」を元に改変・追加したものです。

このドキュメントは、原著作物と同じく[クリエイティブ・コモンズ・ライセンス【表示-継承 4.0 国際】](http://creativecommons.org/licenses/by-sa/4.0/deed.ja)で提供します。
